...
var localAddr *string = flag.String("l", "localhost:9101", "local address")
var remoteAddr *string = flag.String("r", "localhost:9100", "remote address")
